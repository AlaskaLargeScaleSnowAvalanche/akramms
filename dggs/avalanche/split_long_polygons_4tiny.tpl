						<ProcBase Name="release with Length/Width > 3  and Standard deviation DEM &lt; 10  at  L fine: multi-resolution: 20 [shape:0.6 compct.:1.0] creating 'L fine long tiny'" bLoopChg="0" bExpand="1" bActive="1" bAutoName="1" bSubrtn="0">
							...
							<Algorithm guid="6534F2E1-485B-406f-B990-350824399FA8">
								<Params>
									...
									<MapLvlProxy strName="L fine long tiny" bVrbl="0">
						...
						<ProcBase Name="with Existence of super objects release (1) = 1  or Existence of super objects long_large (1) = 1  at  L fine long tiny: release" bLoopChg="0" bExpand="1" bActive="1" bAutoName="1" bSubrtn="0">
							<LcnsInfo sLcnsId="" sPwd=""></LcnsInfo>
							<vrblValMaxCycle>
								<DValue value="1." type="double"></DValue>
							</vrblValMaxCycle>
							...
							<Domain guid="CED621BD-F4D1-4ffa-A2F6-DB2BB1913E8C">
								<Params>
									...
									<TermThrsh>
									<TermGroup eJoint="2">
									<TermCondition eCmpr="5" eBaseUnit="0" eJoint="1">
									<ProcVrblVal1>
									<DValue type="propDscrId">
