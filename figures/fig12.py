...
pub_dir = exp.dir.parents[0] / (exp.dir.parts[-1] + '_publish')
...
#    release_zip = exp.dir / 'ak-ccsm-1981-2010-lapse-For-30' / f'arc-{idom:03d}-{jdom:03d}' / 'RELEASE.zip'
